...
export const DEFAULT_RULES = Object.freeze({
  ...
  gifts: [
    ...
    { name: 'Rosquinha', match: ['Doughnut', 'Donut', 'Rosquinha'], coins: 30, team: 'villain', tier: 'normal',
      effects: { bombs: 3, bolt: 1 }, desc: '3 bombas + 1 raio' },
    { name: 'Confete', match: ['Confetti', 'Confete'], coins: 100, team: 'villain', tier: 'mega',
      effects: { bombs: 8, ice: 1, web: 1 }, desc: '8 bombas + gelo + teia' },
    // 😇 HERÓIS ------------------------------------------------------------------------
    { name: 'GG', match: ['GG'], coins: 1, team: 'hero', tier: 'normal',
      effects: { food: 1 }, desc: '+1 comida dourada' },
    { name: 'Capivara', match: ['Capybara', 'Capivara'], coins: 30, team: 'hero', tier: 'normal',
      effects: { grow: 3, diamond: 1 }, desc: 'cresce +3 e 1 diamante' },
    { name: 'Coração nas Mãos', match: ['Hand Hearts', 'Hands Heart', 'Coração nas Mãos'], coins: 100, team: 'hero', tier: 'mega',
      effects: { clearBombs: true, shieldSec: 30, food: 3, star: 1 }, desc: 'limpa as bombas + escudo 30 s' },
  ],
});
